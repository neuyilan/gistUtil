...
public class LockHangAsyncRemove {
  ...
  private static void cacheInit() {
    RemovalListener<Integer, Integer> async = RemovalListeners
        .asynchronous(new MyRemovalListener(), Executors.newSingleThreadExecutor());
    cache = CacheBuilder.newBuilder()
        .removalListener(async).maximumSize(cacheMaxSize).build();
  }
